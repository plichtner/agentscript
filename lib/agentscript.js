(function() {
  ...
  Color = {
    typedColor: function(r, g, b, a, stringToo) {
      var ta;
      if (a == null) {
        a = 255;
      }
      ...
      this.checkAlpha("typedCcolor", a);
      ta = new Uint8ClampedArray([r, g, b, a]);
      ta.pixelArray = new Uint32Array(ta.buffer);
      if (stringToo) {
        ta.str = a === 255 ? this.hexString(r, g, b) : this.rgbaString(r, g, b, a);
      }
      return ta;
    },
    getPixel: function(color) {
      return color.pixelArray[0];
    },
    setRgba: function(color, r, g, b, a) {
      var _ref;
      if (a == null) {
        a = 255;
      }
      this.checkAlpha("setColor", a);
      _ref = [r, g, b, a], color[0] = _ref[0], color[1] = _ref[1], color[2] = _ref[2], color[3] = _ref[3];
      if (color.str) {
        color.str = this.rgbaString(r, g, b, a);
      }
      return color;
    },
    setPixel: function(color, pixel) {
      color.pixelArray[0] = pixel;
      if (color.str) {
        color.str = this.rgbaString.apply(this, color);
      }
      return color;
    },
    setString: function(color, string) {
      var _ref;
      _ref = this.stringToRgba(color), color[0] = _ref[0], color[1] = _ref[1], color[2] = _ref[2], color[3] = _ref[3];
      if (color.str) {
        return color.str = string;
      }
    },
    toString: function(color) {
      ...
      str = color.str;
      return "[" + ([r, g, b, a].toString()) + (str ? "; str:" + str : void 0) + "]";
    },
    checkAlpha: function(name, a) {
      if ((0 < a && a <= 1)) {
        return console.log("" + name + ": a=" + a + ". Alpha float in (0-1], not int in [0-255]");
      }
    },
    ...
    randomColor: function() {
      var i;
      return this.typedColor.apply(this, (function() {
        var _i, _results;
        _results = [];
        for (i = _i = 0; _i <= 2; i = ++_i) {
    ...
    initSharedPixel: function() {
      ...
      return this.sharedRgba = new Uint8ClampedArray(this.sharedPixel.buffer);
    },
    rgbaToPixel: function(r, g, b, a) {
      ...
      uint8 = this.sharedRgba;
      _ref = [r, g, b, a], uint8[0] = _ref[0], uint8[1] = _ref[1], uint8[2] = _ref[2], uint8[3] = _ref[3];
      return this.sharedPixel[0];
    },
    pixelToRgba: function(pixel) {
      this.sharedPixel[0] = pixel;
      return this.sharedRgba;
    },
    pixelToArray: function(pixel) {
      this.sharedColor.pixelArray[0] = pixel;
      return (function(func, args, ctor) {
        ctor.prototype = func.prototype;
        var child = new ctor, result = func.apply(child, args);
        return Object(result) === result ? result : child;
      })(Array, this.sharedColor, function(){});
    },
    pixelToColor: function(pixel) {
      return this.typedColor.apply(this, this.pixelToRgba(pixel));
    },
    ...
    hexString: function(r, g, b, checkShort) {
      var b0, g0, r0, _ref;
      if (checkShort == null) {
        checkShort = true;
      }
      _ref = [r / 17, g / 17, b / 17], r0 = _ref[0], g0 = _ref[1], b0 = _ref[2];
      if (checkShort && u.isInteger(r0) && u.isInteger(g0) && u.isInteger(b0)) {
    ...
    stringToColor: function(string) {
      return this.typedColor.apply(this, this.stringToRgba(string));
    },
    gradientRgbaArray: function(nColors, stops, locs) {
      var ctx, grad, i, id, _i, _j, _ref, _ref1, _results;
      if (locs == null) {
        locs = (function() {
          var _i, _ref, _results;
      ...
      grad = ctx.createLinearGradient(0, 0, nColors, 0);
      for (i = _i = 0, _ref = stops.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        grad.addColorStop(locs[i], this.rgbaString.apply(this, stops[i]));
      }
      ctx.fillStyle = grad;
      ctx.fillRect(0, 0, nColors, 1);
      ...
      _results = [];
      for (i = _j = 0, _ref1 = id.length; _j < _ref1; i = _j += 4) {
        _results.push([id[i], id[i + 1], id[i + 2], id[i + 3]]);
      }
      return _results;
    },
    ...
    hslToRgb: function(h, s, l) {
      ...
      return this.stringToRgba(str).slice(0, 3);
    },
    ...
    ColorMap: ColorMap = (function(_super) {
      ...
      function ColorMap(colorsArray, indexToo) {
        var color, _i, _len;
        if (indexToo == null) {
          indexToo = false;
        }
        ...
        if (typeof colorsArray === "number") {
          this.cube = colorsArray;
          colorsArray = Color.permuteColors(this.cube);
        }
        for (_i = 0, _len = colorsArray.length; _i < _len; _i++) {
          color = colorsArray[_i];
          this.appendColor(color);
        }
      }

      ColorMap.prototype.appendColor = function(color, useNative) {
        var str, typedColor, _ref;
        typedColor = color.buffer ? color : u.isArray(color) ? Color.typedColor.apply(Color, color) : u.isString(color) ? Color.stringToColor(color) : typeof color === "number" ? Color.pixelToColor(color) : u.error("ColorMap: bad color = " + color);
        typedColor.ix = this.length;
        typedColor.map = this;
        this.push(typedColor);
        if (this.index) {
          str = (_ref = typedColor.str) != null ? _ref : Color.rgbaString.apply(Color, typedColor);
          if (typedColor.str) {
            this.index[typedColor.str] = typedColor;
          }
          if (u.isString(color)) {
            this.index[color] = typedColor;
            this.index[color.toLowerCase()] = typedColor;
          }
        }
        return typedColor;
      };

      ColorMap.prototype.sort = function(compareFcn) {
        var color, i, _i, _len;
        ColorMap.__super__.sort.call(this, compareFcn);
      ...
      ColorMap.prototype.scaleIndex = function(number, min, max, minColor, maxColor) {
        var scale;
        if (minColor == null) {
          minColor = 0;
        }
      ...
      ColorMap.prototype.getRgb = function(r, g, b, a) {
        var i, pixel;
        if (a == null) {
          a = 255;
        }
        if (this.index) {
          return this.index[Color.rgbaString(r, g, b, a)];
        }
        pixel = Color.rgbaToPixel(r, g, b, a);
        i = u.firstOneOf(this, function(color) {
          return color.pixelArray[0] === pixel;
        });
        if (i === -1) {
          return void 0;
        } else {
      ...
      ColorMap.prototype.getClosestRgbCube = function(r, g, b, itemsPerChannel) {
        var bLoc, color, gLoc, i, rLoc, step, _ref;
        ...
        _ref = (function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            color = _ref[_i];
            _results.push(Math.round(color / step));
          }
          return _results;
      ...
      ColorMap.prototype.findClosest = function(r, g, b) {
        var b0, color, d, g0, i, ixMin, minDist, r0, _i, _len;
        if ((color = this.getRgb(r, g, b))) {
          return color;
        }
        if (this.cube) {
          return this.getClosestRgbCube(r, g, b, this.cube);
        }
        minDist = Infinity;
        ixMin = 0;
        for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
          color = this[i];
          r0 = color[0], g0 = color[1], b0 = color[2];
    ...
    convertArray: function(rgba, type) {
      var isTyped, _ref;
      isTyped = rgba.buffer != null;
      switch (type) {
        case "typed":
          if (isTyped) {
            return rgba;
          } else {
            return this.typedColor.apply(this, rgba);
          }
          break;
        case "string":
          return (_ref = rgba.str) != null ? _ref : this.rgbaString.apply(this, rgba);
        case "pixel":
          if (isTyped) {
            return this.getPixel(rgba);
          } else {
            return this.rgbaToPixel.apply(this, rgba);
          }
          break;
        default:
          return u.error("convertColors: unknown color type: " + type);
      }
    },
    convertColor: function(color, type) {
      var isPixel, rgba;
      if (u.isArray(color) || color.buffer) {
        return this.convertArray(color, type);
      }
      isPixel = u.isInteger(color);
      rgba = isPixel ? this.pixelToColor(color) : this.stringToRgba(color);
      return convertArray(rgba, type);
    },
    grayColorMap: function(size) {
      var i;
      if (size == null) {
        size = 256;
      }
    ...
    rgbColorMap: function(R, G, B) {
      ...
      if ((typeof R === "number") && ((R === G && G === B))) {
        return new ColorMap(R);
      } else {
        return new ColorMap(this.permuteColors(R, G, B));
      }
    },
    hslColorMap: function(H, S, L) {
      ...
      return new ColorMap(rgbArray);
    },
    gradientColorMap: function(nColors, stops, locs) {
      return new ColorMap(this.gradientRgbaArray(nColors, stops, locs));
    },
    nameColorMap: function(strings) {
      return new ColorMap(strings);
    },
    pixelColorMap: function(pixels) {
      var rgba;
      if (typeof pixels[0] !== "number") {
        pixels = (function() {
          var _i, _len, _results;
          _results = [];
          for (_i = 0, _len = rgbas.length; _i < _len; _i++) {
            rgba = rgbas[_i];
            _results.push(rgbaToPixel.apply(null, rgba));
          }
          return _results;
        })();
      }
    ...
    randomColorMap: function(nColors) {
      var i;
      return new ColorMap((function() {
        var _i, _results;
        _results = [];
        for (i = _i = 0; 0 <= nColors ? _i < nColors : _i > nColors; i = 0 <= nColors ? ++_i : --_i) {
          _results.push(this.randomColor());
        }
        return _results;
      }).call(this));
    },
    alphaColorMap: function(rgb, nOpacities) {
      var a, _i, _len, _ref;
      if (nOpacities == null) {
        nOpacities = 256;
      }
      ...
      return new ColorMap(this.alphaColorArray(rgb, nOpacities));
    }
  };
  ...
  Model = (function() {
    ...
    Model.prototype.patchBreeds = function(breedNames) {
      return this.patches.breeds = this.createBreeds(breedNames, this.Patch, this.Patches);
    };

    Model.prototype.agentBreeds = function(breedNames) {
      return this.agents.breeds = this.createBreeds(breedNames, this.Agent, this.Agents);
    };

    Model.prototype.linkBreeds = function(breedNames) {
      return this.links.breeds = this.createBreeds(breedNames, this.Link, this.Links);
    };
