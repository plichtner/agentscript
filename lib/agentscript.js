(function() {
  ...
  ABM.Color = Color = {
    ...
    colorObject: function(r, g, b, a, opt) {
      ...
      if (opt.hexString) {
        o.hexString = this.hexString(r, g, b);
      }
      if (opt.intensity) {
    ...
    threeArrays: function(A1, A2, A3) {
      ...
      if (typeof A1 === "number") {
        A1 = (function() {
          var _i, _results;
          _results = [];
          for (i = _i = 0; 0 <= A1 ? _i < A1 : _i > A1; i = 0 <= A1 ? ++_i : --_i) {
            _results.push(Math.round(i * 255 / (A1 - 1)));
          }
          return _results;
        })();
      }
      if (typeof A2 === "number") {
        A2 = (function() {
          var _i, _results;
          _results = [];
          for (i = _i = 0; 0 <= A2 ? _i < A2 : _i > A2; i = 0 <= A2 ? ++_i : --_i) {
            _results.push(Math.round(i * 255 / (A2 - 1)));
          }
          return _results;
        })();
      }
      if (typeof A3 === "number") {
        A3 = (function() {
          var _i, _results;
          _results = [];
          for (i = _i = 0; 0 <= A3 ? _i < A3 : _i > A3; i = 0 <= A3 ? ++_i : --_i) {
            _results.push(Math.round(i * 255 / (A3 - 1)));
          }
          return _results;
        })();
      }
