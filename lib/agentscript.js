(function() {
  ...
  Color = {
    ...
    randomColor: function(type) {
      ...
      return this.arrayToColor(this.randomRgba(), type);
    },
    legacyColor: function(color) {
      var array;
      array = Array.apply(null, this.colorToArray(color));
      if (array[3] === 255) {
        array.pop();
      } else {
        array[3] /= 255;
    ...
    typedColor: (function() {
      ...
      TypedColorProto = {
        toString: function() {
          var _ref;
          return "typedColor:" + (Array.apply(null, this).toString()) + ";css=" + ((_ref = this.string) != null ? _ref : null);
        },
    ...
    ColorMap: ColorMap = (function(_super) {
      ...
      ColorMap.prototype.closestCubeIndex = function(r, g, b) {
        var bLoc, c, gLoc, rLoc, step, _ref;
        if (!this.cube) {
      ...
      ColorMap.prototype.findClosestIndex = function(r, g, b) {
        ...
        if ((ix = this.lookup(Color.arrayToColor([r, g, b], this.type)))) {
          return ix;
        }
        minDist = Infinity;
        ixMin = 0;
    ...
    grayColorMap: function(size, type, indexToo) {
      ...
      return new ColorMap(this.grayArray(size), type, indexToo);
    },
    rgbColorMap: function(R, G, B, type, indexToo) {
      ...
      if ((typeof R === "number") && ((R === G && G === B))) {
        return new ColorMap(R, type, indexToo);
      } else {
        return new ColorMap(this.permuteColors(R, G, B), type, indexToo);
      }
    },
    hslColorMap: function(H, S, L, type, indexToo) {
      ...
      return new ColorMap(cssArray, type, indexToo);
    },
    gradientColorMap: function(nColors, stops, locs, type, indexToo) {
      ...
      return new ColorMap(this.gradientRgbaArray(nColors, stops, locs), type, indexToo);
    },
    ...
    alphaColorMap: function(rgb, nOpacities, type, indexToo) {
      ...
      return new ColorMap(alphaArray(rgb, nOpacities, type, indexToo));
    },
    protoMap: function(array) {
      array.__proto__ = ColorMap.prototype;
      array.type = this.colorType(array[0]);
      return array;
    },
    nameProtoMap: function(strings) {
      return this.protoMap(strings);
    },
    nameColorMap: function(strings, type, indexToo) {
      if (type == null) {
        type = "css";
      }
      if (indexToo == null) {
      ...
      return new ColoMap(strings, type, indexToo);
    },
    pixelProtoMap: function(pixels) {
      return this.protoMap(pixels);
    },
    pixelColorMap: function(pixels, type, indexToo) {
      if (type == null) {
        type = "pixel";
      }
      if (indexToo == null) {
      ...
      return new ColorMap(pixels, type, indexToo);
    }
  };
