  ...
  Color = {
    ...
    checkType: function(type) {
      if (!this.isValidType(type)) {
        return u.error("Bad color type " + type);
      }
    },
    isValidArray: function(array) {
      var _ref;
      return (u.isArray(array) || array.buffer) && (_ref = array.length, __indexOf.call([3, 4], _ref) >= 0);
    },
    checkArray: function(array) {
      if (!this.isValidArray(array)) {
        return u.error("Bad array: " + array + "/" + array.length);
      }
    },
    arrayToColor: function(array, type) {
      ...
      return u.error("arrayToColor problem");
    },
    ...
    randomColor: function(type) {
      return this.arrayToColor.apply(this, __slice.call(this.randomRgba()).concat([type]));
    },
    ...
    stringToRgba: function(string) {
      ...
      })(Array, this.stringToUint8s(string), function(){});
    },
    gradientDataArray: function(nColors, stops, locs) {
      ...
      if (u.isArray(stops[0])) {
        stops = (function() {
          ...
          for (_i = 0, _len = stops.length; _i < _len; _i++) {
            a = stops[_i];
            _results.push(this.arrayToColor(a, "css"));
          }
          return _results;
        }).call(this);
      }
    ...
    gradientRgbaArray: function(nColors, stops, locs) {
      ...
      id = this.gradientDataArray(nColors, stops, locs);
      _results = [];
      for (i = _i = 0, _ref = id.length; _i < _ref; i = _i += 4) {
        _results.push([id[i], id[i + 1], id[i + 2], id[i + 3]]);
      }
      return _results;
    },
    gradientPixelArray: function(nColors, stops, locs) {
      return new Uint32Array(this.gradientDataArray(nColors, stops, locs).buffer);
    },
    sharedPixel: null,
    sharedUint8s: null,
    ...
    rgbaToPixel: function(r, g, b, a) {
      ...
      for (i = _i = 0; _i <= 3; i = ++_i) {
        this.sharedUint8s[i] = [r, g, b, a][i];
      }
      return this.sharedPixel[0];
    },
    pixelToUint8s: function(pixel) {
    ...
    pixelToRgba: function(pixel) {
      return (function(func, args, ctor) {
        ...
        var child = new ctor, result = func.apply(child, args);
        return Object(result) === result ? result : child;
      })(Array, this.pixelToUint8s(pixel), function(){});
    },
    ...
    typedColor: (function() {
      ...
      TypedColorProto = {
        toArray: function(aFloat) {
          if (aFloat == null) {
            aFloat = false;
          }
          return [this[0], this[1], this[2], aFloat ? this[3] / 255 : this[3]];
        },
        toString: function() {
          return "" + (this.toArray().toString()) + (this.str ? ":" + this.str : "");
        },
        setColor: function(r, g, b, a) {
          ...
          _ref = [r, g, b, a], this[0] = _ref[0], this[1] = _ref[1], this[2] = _ref[2], this[3] = _ref[3];
          if (this.str) {
        ...
        getString: function(string) {
          if (!this.str) {
            this.str = Color.triString.apply(Color, this);
          }
          return this.str;
        }
      };
    ...
    ColorMap: ColorMap = (function(_super) {
      ...
      function ColorMap(colorsArray, type, indexToo) {
        var c, color, type0, _i, _len;
        this.type = type != null ? type : "typed";
        if (indexToo == null) {
          indexToo = type === "typed";
        }
        ...
        if (type0 && (type0 !== type)) {
          ...
          colorsArray = (function() {
            ...
            for (_i = 0, _len = colorsArray.length; _i < _len; _i++) {
              c = colorsArray[_i];
              _results.push(Color.colorToArray(c));
            }
            return _results;
          })();
        }
        for (_i = 0, _len = colorsArray.length; _i < _len; _i++) {
          ...
          this.appendColor(color, type);
        }
      }

      ColorMap.prototype.appendColor = function(color) {
        if (Color.isValidArray(color)) {
          color = Color.arrayToColor(color, this.type);
        }
        if (this.index) {
          this.index[this.indexKey(color)] = this.length;
        }
        if (this.type === "typed") {
      ...
      ColorMap.prototype.indexKey = function(color) {
        if (this.type === "typed") {
          return color.pixel;
        } else {
          return color;
      ...
      ColorMap.prototype.colorsEqual = function(color1, color2) {
      ...
      ColorMap.prototype.lookup = function(color) {
        var c, i;
        if (this.index) {
        ...
        if ((function() {
          ...
          for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
            c = this[i];
            _results.push(this.colorsEqual(color, c));
          }
          return _results;
        }).call(this)) {
          return i;
      ...
      ColorMap.prototype.closestCubeIndex = function(r, g, b) {
        var bLoc, color, gLoc, rLoc, step, _ref;
        if (!this.cube) {
          u.error("closestCubeIndex: not a color cube");
        }
      ...
      ColorMap.prototype.closestCubeColor = function(r, g, b) {
        return this[this.closestCubeIndex(r, g, b)];
      };

      ColorMap.prototype.findClosestIndex = function(r, g, b) {
        var b0, color, d, g0, i, ix, ixMin, minDist, r0, _i, _len, _ref;
        if (this.cube) {
          return this.closestCubeIndex(r, g, b);
        }
        if ((ix = this.lookup(Color.arrayToColor([r, g, b])))) {
          return ix;
        }
        minDist = Infinity;
        ixMin = 0;
        for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
          color = this[i];
          _ref = Color.colorToArray(color), r0 = _ref[0], g0 = _ref[1], b0 = _ref[2];
      ...
      ColorMap.prototype.findClosestColor = function(r, g, b) {
        return this[this.findClosestIndex(r, g, b)];
      };
    ...
    grayColorMap: function(size, type) {
      if (size == null) {
        size = 256;
      }
      if (type == null) {
      ...
      return new ColorMap(this.grayArray(size), type);
    },
    rgbColorMap: function(R, G, B, type) {
      if (G == null) {
        G = R;
      }
      if (B == null) {
      ...
      if ((typeof R === "number") && ((R === G && G === B))) {
        return new ColorMap(R, type);
      } else {
        return new ColorMap(this.permuteColors(R, G, B), type);
      }
    },
    hslColorMap: function(H, S, L, type) {
      var a, cssArray, hslArray;
      if (S == null) {
        S = 1;
      }
      if (L == null) {
      ...
      cssArray = (function() {
        ...
        for (_i = 0, _len = hslArray.length; _i < _len; _i++) {
          a = hslArray[_i];
          _results.push(this.hslString.apply(this, a));
        }
        return _results;
      }).call(this);
      return new ColorMap(cssArray, type);
    },
    gradientColorMap: function(nColors, stops, locs, type) {
      if (type == null) {
        type = "typed";
      }
      return new ColorMap(this.gradientRgbaArray(nColors, stops, locs), type);
    },
    randomColorMap: function(nColors, type) {
      var i;
      if (type == null) {
        type = "typed";
      }
      return new ColorMap((function() {
        ...
        for (i = _i = 0; 0 <= nColors ? _i < nColors : _i > nColors; i = 0 <= nColors ? ++_i : --_i) {
          _results.push(this.randomRgba());
        }
        return _results;
      }).call(this), type);
    },
    alphaColorMap: function(rgb, nOpacities, type) {
      var a, alphaArray;
      if (nOpacities == null) {
        nOpacities = 256;
      }
      ...
      alphaArray = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          a = _ref[_i];
          _results.push(u.clone(rgb).push(a));
        }
        return _results;
      })();
      return new ColorMap(alphaArray(rgb, nOpacities, type = "typed"));
    },
    arrayToMap: function(array) {
      array.__proto__ = ColorMap.prototype;
      array.type = this.colorType(array[0]);
      return array;
    },
    nameColorMap: function(strings) {
      return this.arrayToMap(strings);
    },
    pixelColorMap: function(pixels) {
      return this.arrayToMap(pixels);
    }
  };
