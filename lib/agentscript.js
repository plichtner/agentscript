(function() {
  ...
  Util = util = u = {
    ...
    deprecated: function(s) {
      if (this.deprecatedMsgs.length === 0) {
  ...
  ColorMaps.sharedJet = ColorMaps.gradientColorMap(256, ColorMaps.jetColors);

  ColorMaps.randomGray = function() {
    return ColorMaps.sharedGray.randomColor();
  };

  ColorMaps.randomColor = function() {
    return ColorMaps.sharedRgb256.randomColor();
  };
  ...
  Patches = (function(_super) {
    ...
    Patches.prototype.diffuse = function(v, rate, c) {
      var dv, dv8, map, minVal, n, nn, p, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1;
      ...
      for (_l = 0, _len3 = this.length; _l < _len3; _l++) {
        ...
        p._diffuseNext = 0;
        if (c) {
          map = (_ref1 = p.colorMap) != null ? _ref1 : ColorMaps.sharedJet;
