  ...
  ColorMaps = {
    ...
    ColorMapProto: {
      ...
      findClosestIndex: function(r, g, b, a) {
        var b0, bLoc, c, color, d, g0, gLoc, i, ix, ixMin, minDist, r0, rLoc, step, _i, _len, _ref, _ref1, _ref2;
        if (a == null) {
          a = 255;
        }
        if (g == null) {
          _ref = Color.colorToArray(r), r = _ref[0], g = _ref[1], b = _ref[2], a = _ref[3];
        }
        if (this.cube) {
          ...
          _ref1 = (function() {
            ...
            return _results;
          })(), rLoc = _ref1[0], gLoc = _ref1[1], bLoc = _ref1[2];
        ...
        for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
          color = this[i];
          _ref2 = Color.colorToArray(color), r0 = _ref2[0], g0 = _ref2[1], b0 = _ref2[2];
    ...
    namedColorMap: function(names, width, whiteToo) {
      var color, k, map, n, name, o, ramps, v, _i, _len;
      map = [];
      ramps = {};
      if (u.isArray(names)) {
        o = {};
  ...
  AgentSet = (function(_super) {
    ...
    AgentSet.prototype.setDefault = function(name, value) {
      ...
      if (name.match(/color/i) && u.isArray(value)) {
        value = (_ref = ColorMaps.Rgb).findClosestColor.apply(_ref, value);
      }
