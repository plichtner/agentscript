(function() {
  ...
  ABM.Color = Color = {
    colorObject: function(r, g, b, a) {
      ...
      o.hexColor = this.hexColor(r, g, b);
      o.intensity = this.rgbIntensity(r, g, b);
      o.temp = this.rgbDistance(0, 0, 0, r, g, b);
      return o;
    },
    ...
    ColorMap: ColorMap = (function(_super) {
      ...
      ColorMap.prototype.findRGB = function(r, g, b) {
        var color, i, _i, _len;
        for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
          color = this[i];
      ...
      ColorMap.prototype.find = function(key, value) {
        var color, i, _i, _len;
        for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
          color = this[i];
          if (color[key] === value) {
      ...
      ColorMap.prototype.closestRGB = function(r, g, b) {
    ...
    rgbColorArray: function(R, G, B) {
      var array, b, g, i, r, _i, _j, _k, _len, _len1, _len2;
      if (G == null) {
        G = R;
      }
      if (B == null) {
    ...
    rgbColorMap: function(R, G, B) {
      ...
      return new ColorMap(this.rgbColorArray(R, G, B));
    },
    hsvColorArray: function(nHues, s, b) {
      var i, _i, _results;
      if (nHues == null) {
        nHues = 256;
      }
      ...
      _results = [];
      for (i = _i = 0; 0 <= nHues ? _i < nHues : _i > nHues; i = 0 <= nHues ? ++_i : --_i) {
        _results.push(Color.hsvToRgb(i * 255 / (nHues - 1), s, b));
      }
      return _results;
    },
    hsvColorMap: function(nHues, s, b) {
      if (nHues == null) {
        nHues = 256;
      }
      if (s == null) {
      ...
      return new ColorMap(this.hsvColorArray(nHues, s, b));
    },
    gradientColorArray: function(nColors, stops, locs) {
      var can, ctx, grad, i, id, _i, _j, _ref, _ref1, _results;
      if (locs == null) {
        locs = (function() {
          var _i, _ref, _results;
          _results = [];
      ...
      grad = ctx.createLinearGradient(0, 0, nColors, 0);
      for (i = _i = 0, _ref = stops.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        grad.addColorStop(locs[i], Color.rgbString.apply(Color, stops[i]));
      }
      ctx.fillStyle = grad;
      ctx.fillRect(0, 0, nColors, 1);
    ...
    gradientColorMap: function(nColors, stops, locs) {
      return new ColorMap(this.gradientColorArray(nColors, stops, locs));
    },
    nameColorMap: function(colorsString) {
      var c, colorString, colorStrings, h, hexes, i, map, names, rgbs, toint, _i, _len;
      colorStrings = colorsString.split(" ");
      names = (function() {
        var _i, _len, _results;
        _results = [];
        for (_i = 0, _len = colorStrings.length; _i < _len; _i++) {
          colorString = colorStrings[_i];
          _results.push(colorString.slice(6));
        }
        return _results;
      })();
      hexes = (function() {
        ...
        for (_i = 0, _len = colorStrings.length; _i < _len; _i++) {
          colorString = colorStrings[_i];
          _results.push(colorString.slice(0, 6));
        }
        return _results;
      })();
      toint = function(str, start) {
        return parseInt(str.slice(start, start + 2), 16);
      };
      rgbs = (function() {
        var _i, _len, _results;
        _results = [];
        for (_i = 0, _len = hexes.length; _i < _len; _i++) {
          h = hexes[_i];
          _results.push([toint(h, 0), toint(h, 2), toint(h, 4)]);
        }
        return _results;
      })();
  ...
  ABM.Model = (function() {
    ...
    function Model(divOrOpts, size, minX, maxX, minY, maxY, isTorus, hasNeighbors, isHeadless) {
      ...
      this.Patches = ABM.Patches;
      this.Patch = u.cloneClass(ABM.Patch);
      this.Agents = ABM.Agents;
      this.Agent = u.cloneClass(ABM.Agent);
      this.Links = ABM.Links;
      this.Link = u.cloneClass(ABM.Link);
