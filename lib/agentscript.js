(function() {
  var Agent, AgentSet, Agents, Animator, Color, ColorMaps, Evented, Link, Links, Model, Patch, Patches, Shapes, Util, shapes, u, util,
  ...
  ColorMaps = {
    ...
    ColorMapProto: {
      ...
      findClosestIndex: function(r, g, b) {
      ...
      findClosestColor: function(r, g, b) {
    ...
    rgbColorArray: function(R, G, B, type) {
      var array;
      array = this.permuteColors(R, G, B);
      if ((typeof R === "number") && ((R === G && G === B))) {
        array.cube = R;
      }
      return this.arrayToColors(array, type);
    },
    rgbColorMap: function(R, G, B, type, indexToo) {
      ...
      return this.colorMap(this.rgbColorArray(R, G, B, type), indexToo);
    },
    hslColorArray: function(H, S, L, type) {
    ...
    hslColorMap: function(H, S, L, type, indexToo) {
      ...
      return this.colorMap(this.hslColorArray(H, S, L, type), indexToo);
    },
    gradientColorArray: function(nColors, stops, locs, type) {
      var id;
      id = this.gradientImageData(nColors, stops, locs);
      return this.uint8ArrayToColors(id, type);
    },
    gradientColorMap: function(nColors, stops, locs, type, indexToo) {
      ...
      array = this.gradientColorArray(nColors, stops, locs, type);
      return this.colorMap(array, indexToo);
    },
    alphaColorArray: function(rgb, nOpacities, type) {
      var a, array, b, g, r;
    ...
    alphaColorMap: function(rgb, nOpacities, type, indexToo) {
      ...
      array = this.alphaColorArray(rgb, nOpacities, type);
      return this.colorMap(array, indexToo);
    }
  };
