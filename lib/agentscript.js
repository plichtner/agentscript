(function() {
  var Agent, AgentSet, Agents, Animator, Color, ColorMap, ColorMaps, Evented, Link, Links, Model, Patch, Patches, Shapes, Util, shapes, u, util,
    ...
    typedColor: (function() {
      ...
      typedColor = function(r, g, b, a, map, index) {
        ...
        if (map) {
          ...
          ua = g ? new Uint8ClampedArray([r, g, b, a]) : r;
        }
  ...
  ColorMaps = {
    ColorMap: ColorMap = (function(_super) {
      ...
      function ColorMap(colorsArray, type, indexToo) {
        ...
        if (typeof colorsArray === "number") {
          ...
          colorsArray = ColorMaps.permuteColors(this.cube);
        }
      ...
      ColorMap.prototype.isValidArray = function(array) {
        var _ref;
      ...
      ColorMap.prototype.randomIndex = function(start, stop) {
        if (start == null) {
          start = 0;
        }
        if (stop == null) {
      ...
      ColorMap.prototype.randomColor = function(start, stop) {
        if (start == null) {
          start = 0;
        }
        if (stop == null) {
    ...
    gradientUint8Array: function(nColors, stops, locs) {
    ...
    gradientUint8sArray: function(nColors, stops, locs) {
      return this.uintArrayToUint8s(this.gradientUint8Array(nColors, stops, locs));
    },
    gradientPixelArray: function(nColors, stops, locs) {
      return new Uint32Array(this.gradientUint8Array(nColors, stops, locs).buffer);
    },
    uintArrayToUint8s: function(uint8Array) {
      var i, _i, _ref, _results;
      _results = [];
      for (i = _i = 0, _ref = uint8Array.length; _i < _ref; i = _i += 4) {
        _results.push(uint8Array.subarray(i, i + 4));
      }
      return _results;
    },
    ...
    grayColorMap: function(size, type, indexToo) {
      ...
      return new this.ColorMap(this.grayArray(size), type, indexToo);
    },
    rgbColorMap: function(R, G, B, type, indexToo) {
      ...
      if ((typeof R === "number") && ((R === G && G === B))) {
        return new this.ColorMap(R, type, indexToo);
      } else {
        return new this.ColorMap(this.permuteColors(R, G, B), type, indexToo);
      }
    },
    hslColorMap: function(H, S, L, type, indexToo) {
      ...
      return new this.ColorMap(cssArray, type, indexToo);
    },
    gradientColorMap: function(nColors, stops, locs, type, indexToo) {
      ...
      return new this.ColorMap(this.gradientUint8sArray(nColors, stops, locs), type, indexToo);
    },
    randomColorMap: function(nColors, type, indexToo) {
      ...
      return new this.ColorMap((function() {
        var _i, _results;
        _results = [];
    ...
    alphaColorMap: function(rgb, nOpacities, type, indexToo) {
      ...
      return new this.ColorMap(alphaArray(rgb, nOpacities, type, indexToo));
    },
    ...
    cssProtoMap: function(strings) {
      return this.protoMap(strings);
    },
    cssColorMap: function(strings, type, indexToo) {
      if (type == null) {
        type = "css";
      }
      if (indexToo == null) {
      ...
      return new this.ColorMap(strings, type, indexToo);
    },
    ...
    pixelColorMap: function(pixels, type, indexToo) {
      ...
      return new this.ColorMap(pixels, type, indexToo);
    }
  };
