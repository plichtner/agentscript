(function() {
  ...
  (function() {
    ...
    window.cancelAnimFrame = window.cancelAnimationFrame || null;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      window.requestAnimFrame || (window.requestAnimFrame = window[vendor + 'RequestAnimationFrame']);
      window.cancelAnimFrame || (window.cancelAnimFrame = window[vendor + 'CancelAnimationFrame']);
      window.cancelAnimFrame || (window.cancelAnimFrame = window[vendor + 'CancelRequestAnimationFrame']);
    }
    window.requestAnimFrame || (window.requestAnimFrame = function(callback) {
      return window.setTimeout(callback, 1000 / 60);
    });
    return window.cancelAnimFrame || (window.cancelAnimFrame = function(id) {
