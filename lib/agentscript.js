(function() {
  var Agent, AgentSet, Agents, Animator, Color, ColorMap, Link, Links, Model, Patch, Patches, Shapes, Util, shapes, u, util,
  ...
  Color = {
    ...
    stringToRGB: function(string) {
      ...
      if ((r + g + b !== 0) || (string === "#000" || string === "#000000" || string === "transparent" || string === "black") || (string.match(/rgba{0,1}\(0,0,0/i)) || (string.match(/hsla{0,1}\(0,0%,0%/i))) {
        return [r, g, b];
      }
      return null;
    },
    round255: function(float) {
      if (!((0 <= float && float <= 1))) {
        u.error("round255: float out of range");
      }
      return u.clamp(Math.round(255 * float), 0, 255);
    },
    rgbToHsv: function(r, g, b) {
      ...
      return [this.round255(h / 6), this.round255(s), this.round255(v)];
    },
    hsvToRgb: function(h, s, v) {
      ...
      return [this.round255(r), this.round255(g), this.round255(b)];
    },
    ...
    grayColorMap: function(size, options, dupsOK) {
      var i;
      if (size == null) {
        size = 256;
      }
      return new ColorMap((function() {
        ...
        return _results;
      }).call(this), options, dupsOK);
    },
    threeArrays: function(A1, A2, A3) {
      var A, a1, a2, a3, array, _i, _j, _k, _len, _len1, _len2, _ref;
      if (A2 == null) {
        A2 = A1;
      }
      if (A3 == null) {
    ...
    rgbColorMap: function(R, G, B, options, dupsOK) {
      ...
      return new ColorMap(this.rgbColorArray(R, G, B), options, dupsOK);
    },
    ...
    hsvColorMap: function(H, S, V, options, dupsOK) {
      if (S == null) {
        S = [255];
      }
      if (V == null) {
      ...
      return new ColorMap(this.hsvColorArray(H, S, V), options, dupsOK);
    },
