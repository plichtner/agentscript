(function() {
  ...
  Util = util = u = {
    ...
    aRamp: function(start, stop, numItems) {
      ...
      return this.aRange(start, stop, step);
    },
  ...
  window.c = Color = {
    ...
    colorObject: function(r, g, b, a, opt) {
      ...
      if (opt.hsl) {
        o.hsl = this.rgbToHsl(r, g, b);
        _ref = o.hsl, o.h = _ref[0], o.s = _ref[1], o.l = _ref[2];
      }
      if (opt.pixel) {
    ...
    permuteColors: function(isRGB, A1, A2, A3) {
      ...
      max = isRGB ? [255, 255, 255] : [360, 100, 100];
      _ref = (function() {
        var _i, _len, _ref, _results;
        _ref = [A1, A2, A3];
        _results = [];
    ...
    rgbColorArray: function(R, G, B) {
      ...
      return this.permuteColors(R, G, B);
    },
    ...
    hslColorMap: function(H, S, L, options, dupsOK) {
      ...
      return new ColorMap(this.hslColorArray(H, S, L), options, dupsOK);
    },
